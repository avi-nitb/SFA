...
public class AllSKUsFragment extends Fragment
{
    ...
    {
        layout = inflater.inflate(R.layout.fragment_all_skus, container, false);
    ...
    private void setAdapter(View layout)
    {
        ...
        String SQL_SELECT_ALL_SKUs = "select sku_id, sku_name, sku_price, sku_category, sku_photo_source from " + TBL_SKU + " ;";
