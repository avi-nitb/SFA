...
public class NewSKUsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        layout = inflater.inflate(R.layout.fragment_new_skus, container, false);
      ...
      /*  String SQL_SELECT_NEW_SKUs = "select sku_id, sku_name, sku_price, sku_category, sku_photo_source from " + TBL_SKU + " WHERE new_sku = ?" + " ;";
    ...
    private void networkcall_for_getSKUlistAfter(final String authToken)
    {
        ...
        call.enqueue(new Callback<GetSkuListAfter>()
        {
            ...
            public void onResponse(Call<GetSkuListAfter> call, Response<GetSkuListAfter> response)
            {
                ...
                {
                    Utils.dismissProgressDialog(progressDialog);
                 //   Utils.showToast(getActivity(), "New : Unsuccessful api call for getSkuListAfter ");
                }
