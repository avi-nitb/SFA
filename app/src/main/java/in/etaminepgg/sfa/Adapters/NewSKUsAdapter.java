...
public class NewSKUsAdapter extends RecyclerView.Adapter<NewSKUsAdapter.SkuInfoViewHolder>
{
    ...
    public void onBindViewHolder(SkuInfoViewHolder skuInfoViewHolder, int position)
    {
        ...
        //skuInfoViewHolder.skuPhoto_ImageView.setImageResource(skuCategory);
    }
